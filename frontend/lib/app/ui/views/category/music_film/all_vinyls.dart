...
class AllVinylsPage extends StatefulWidget {
  const AllVinylsPage({Key? key}) : super(key: key);

  @override
  _AllVinylsPageState createState() => _AllVinylsPageState();
}

class _AllVinylsPageState extends State<AllVinylsPage> {
