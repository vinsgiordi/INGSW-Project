...
import '../../../../data/provider/auction_provider.dart'; // Provider delle aste
import '../../../../data/provider/favorites_provider.dart'; // Provider dei preferiti
import '../../../../data/provider/bid_provider.dart'; // Provider per le offerte

class MusicFilmAndCamerasPage extends StatefulWidget {
  const MusicFilmAndCamerasPage({Key? key}) : super(key: key);

  @override
  _MusicFilmAndCamerasPageState createState() => _MusicFilmAndCamerasPageState();
}

class _MusicFilmAndCamerasPageState extends State<MusicFilmAndCamerasPage> {
  ...
  Future<void> _loadAuctions() async {
    ...
    if (_currentUserToken != null) {
      try {
        await auctionProvider.fetchAuctionsByCategory(_currentUserToken!, '12'); // Categoria "Musica, film e fotocamere"
        setState(() {
          isLoading = false;
        });
      } catch (e) {
