...
class AllCamerasPage extends StatefulWidget {
  const AllCamerasPage({Key? key}) : super(key: key);

  @override
  _AllCamerasPageState createState() => _AllCamerasPageState();
}

class _AllCamerasPageState extends State<AllCamerasPage> {
