...
class AllHistoricalMemorabiliaPage extends StatefulWidget {
  const AllHistoricalMemorabiliaPage({Key? key}) : super(key: key);

  @override
  _AllHistoricalMemorabiliaPageState createState() => _AllHistoricalMemorabiliaPageState();
}

class _AllHistoricalMemorabiliaPageState extends State<AllHistoricalMemorabiliaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cimeli storici'),
        actions: [
          IconButton(
