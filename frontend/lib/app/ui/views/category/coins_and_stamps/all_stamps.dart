...
class AllStampsPage extends StatefulWidget {
  const AllStampsPage({Key? key}) : super(key: key);

  @override
  _AllStampsPageState createState() => _AllStampsPageState();
}

class _AllStampsPageState extends State<AllStampsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i francobolli'),
        actions: [
          IconButton(
