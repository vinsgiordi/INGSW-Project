...
class AllEuroCoinsPage extends StatefulWidget {
  const AllEuroCoinsPage({Key? key}) : super(key: key);

  @override
  _AllEuroCoinsPageState createState() => _AllEuroCoinsPageState();
}

class _AllEuroCoinsPageState extends State<AllEuroCoinsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le monete di euro'),
        actions: [
          IconButton(
