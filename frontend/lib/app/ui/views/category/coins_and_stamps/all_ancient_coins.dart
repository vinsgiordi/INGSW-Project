...
class AllAncientCoinsPage extends StatefulWidget {
  const AllAncientCoinsPage({Key? key}) : super(key: key);

  @override
  _AllAncientCoinsPageState createState() => _AllAncientCoinsPageState();
}

class _AllAncientCoinsPageState extends State<AllAncientCoinsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le monete antiche'),
        actions: [
          IconButton(
