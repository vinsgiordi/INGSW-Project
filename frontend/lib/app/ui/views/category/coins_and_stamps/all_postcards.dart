...
class AllPostcardsPage extends StatefulWidget {
  const AllPostcardsPage({Key? key}) : super(key: key);

  @override
  _AllPostcardsPageState createState() => _AllPostcardsPageState();
}

class _AllPostcardsPageState extends State<AllPostcardsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le cartoline'),
        actions: [
          IconButton(
