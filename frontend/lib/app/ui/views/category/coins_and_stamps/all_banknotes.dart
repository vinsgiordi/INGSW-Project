...
class AllBanknotesPage extends StatefulWidget {
  const AllBanknotesPage({Key? key}) : super(key: key);

  @override
  _AllBanknotesPageState createState() => _AllBanknotesPageState();
}

class _AllBanknotesPageState extends State<AllBanknotesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le banconote'),
        actions: [
          IconButton(
