...
class CoinsAndStampsPage extends StatefulWidget {
  const CoinsAndStampsPage({Key? key}) : super(key: key);

  @override
  _CoinsAndStampsPageState createState() => _CoinsAndStampsPageState();
}

class _CoinsAndStampsPageState extends State<CoinsAndStampsPage> {
  ...
  Future<void> _loadAuctions() async {
    ...
    if (_currentUserToken != null) {
      try {
        await auctionProvider.fetchAuctionsByCategory(_currentUserToken!, '5'); // Passiamo il token e la categoria
        setState(() {
          isLoading = false;
        });
      } catch (e) {
