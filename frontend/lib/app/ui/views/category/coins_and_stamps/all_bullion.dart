...
class AllBullionPage extends StatefulWidget {
  const AllBullionPage({Key? key}) : super(key: key);

  @override
  _AllBullionPageState createState() => _AllBullionPageState();
}

class _AllBullionPageState extends State<AllBullionPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i lingotti'),
        actions: [
          IconButton(
