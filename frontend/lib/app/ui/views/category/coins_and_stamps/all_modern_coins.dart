...
class AllModernCoinsPage extends StatefulWidget {
  const AllModernCoinsPage({Key? key}) : super(key: key);

  @override
  _AllModernCoinsPageState createState() => _AllModernCoinsPageState();
}

class _AllModernCoinsPageState extends State<AllModernCoinsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le monete moderne'),
        actions: [
          IconButton(
