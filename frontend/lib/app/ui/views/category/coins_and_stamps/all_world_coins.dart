...
class AllWorldCoinsPage extends StatefulWidget {
  const AllWorldCoinsPage({Key? key}) : super(key: key);

  @override
  _AllWorldCoinsPageState createState() => _AllWorldCoinsPageState();
}

class _AllWorldCoinsPageState extends State<AllWorldCoinsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le monete mondiali'),
        actions: [
          IconButton(
