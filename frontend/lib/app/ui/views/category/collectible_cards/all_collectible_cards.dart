...
class AllCollectibleCardsPage extends StatefulWidget {
  const AllCollectibleCardsPage({Key? key}) : super(key: key);

  @override
  _AllCollectibleCardsPageState createState() => _AllCollectibleCardsPageState();
}

class _AllCollectibleCardsPageState extends State<AllCollectibleCardsPage> {
