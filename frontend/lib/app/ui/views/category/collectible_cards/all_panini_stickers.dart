...
class AllPaniniStickersPage extends StatefulWidget {
  const AllPaniniStickersPage({Key? key}) : super(key: key);

  @override
  _AllPaniniStickersPageState createState() => _AllPaniniStickersPageState();
}

class _AllPaniniStickersPageState extends State<AllPaniniStickersPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Figurine Panini'),
        actions: [
          IconButton(
