...
class AllSportsStickersPage extends StatefulWidget {
  const AllSportsStickersPage({Key? key}) : super(key: key);

  @override
  _AllSportStickersPageState createState() => _AllSportStickersPageState();
}

class _AllSportStickersPageState extends State<AllSportsStickersPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Figurine sportive'),
        actions: [
          IconButton(
