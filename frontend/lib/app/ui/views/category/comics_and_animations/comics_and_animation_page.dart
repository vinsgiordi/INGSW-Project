...
class ComicsAndAnimationPage extends StatefulWidget {
  const ComicsAndAnimationPage({Key? key}) : super(key: key);

  @override
  _ComicsAndAnimationPageState createState() => _ComicsAndAnimationPageState();
}

class _ComicsAndAnimationPageState extends State<ComicsAndAnimationPage> {
  ...
  String? _currentUserToken; // Token utente
  ...
  Future<void> _loadAuctions() async {
    ...
    if (_currentUserToken != null) {
      try {
        await auctionProvider.fetchAuctionsByCategory(_currentUserToken!, '6'); // Categoria per Fumetti e Animazione
        setState(() {
          isLoading = false;
        });
      } catch (e) {
