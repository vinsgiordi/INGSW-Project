...
class AllMangaAndAnimationPage extends StatefulWidget {
  const AllMangaAndAnimationPage({Key? key}) : super(key: key);

  @override
  _AllMangaAndAnimationPageState createState() => _AllMangaAndAnimationPageState();
}

class _AllMangaAndAnimationPageState extends State<AllMangaAndAnimationPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i manga e animazione'),
        actions: [
          IconButton(
