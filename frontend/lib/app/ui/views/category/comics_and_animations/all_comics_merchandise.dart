...
class AllComicsMerchandisePage extends StatefulWidget {
  const AllComicsMerchandisePage({Key? key}) : super(key: key);

  @override
  _AllComicsMerchandisePageState createState() => _AllComicsMerchandisePageState();
}

class _AllComicsMerchandisePageState extends State<AllComicsMerchandisePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i merchandise e statuine di fumetti'),
        actions: [
          IconButton(
