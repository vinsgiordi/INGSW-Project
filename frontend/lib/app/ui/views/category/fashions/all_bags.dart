...
class AllBagsPage extends StatefulWidget {
  const AllBagsPage({Key? key}) : super(key: key);

  @override
  _AllBagsPageState createState() => _AllBagsPageState();
}

class _AllBagsPageState extends State<AllBagsPage> {
