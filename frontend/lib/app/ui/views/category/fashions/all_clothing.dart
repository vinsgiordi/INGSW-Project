...
class AllClothingPage extends StatefulWidget {
  const AllClothingPage({Key? key}) : super(key: key);

  @override
  _AllClothingPageState createState() => _AllClothingPageState();
}

class _AllClothingPageState extends State<AllClothingPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Abbigliamento'),
        actions: [
          IconButton(
