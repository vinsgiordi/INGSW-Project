...
class AllFashionAccessoriesPage extends StatefulWidget {
  const AllFashionAccessoriesPage({Key? key}) : super(key: key);

  @override
  _AllFashionAccessoriesPageState createState() => _AllFashionAccessoriesPageState();
}

class _AllFashionAccessoriesPageState extends State<AllFashionAccessoriesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Accessori moda'),
        actions: [
          IconButton(
