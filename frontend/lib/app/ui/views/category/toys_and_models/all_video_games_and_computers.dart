...
class AllVideoGamesAndComputersPage extends StatefulWidget {
  const AllVideoGamesAndComputersPage({Key? key}) : super(key: key);

  @override
  _AllVideoGamesAndComputersPageState createState() => _AllVideoGamesAndComputersPageState();
}

class _AllVideoGamesAndComputersPageState extends State<AllVideoGamesAndComputersPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i videogiochi e computer'),
        actions: [
          IconButton(
