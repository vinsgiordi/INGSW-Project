...
class AllLegoPage extends StatefulWidget {
  const AllLegoPage({Key? key}) : super(key: key);

  @override
  _AllLegoPageState createState() => _AllLegoPageState();
}

class _AllLegoPageState extends State<AllLegoPage> {
