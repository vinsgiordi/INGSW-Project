...
class ToysAndModelsPage extends StatefulWidget {
  const ToysAndModelsPage({Key? key}) : super(key: key);

  @override
  _ToysAndModelsPageState createState() => _ToysAndModelsPageState();
}

class _ToysAndModelsPageState extends State<ToysAndModelsPage> {
  ...
  Future<void> _loadAuctions() async {
    ...
    if (_currentUserToken != null) {
      try {
        await auctionProvider.fetchAuctionsByCategory(_currentUserToken!, '9'); // Categoria "Giocattoli e modellini"
        setState(() {
          isLoading = false;
        });
      } catch (e) {
