...
class AllToysPage extends StatefulWidget {
  const AllToysPage({Key? key}) : super(key: key);

  @override
  _AllToysPageState createState() => _AllToysPageState();
}

class _AllToysPageState extends State<AllToysPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i giocattoli'),
        actions: [
          IconButton(
