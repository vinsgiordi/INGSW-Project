...
class AllMineralsAndMeteoritesPage extends StatefulWidget {
  const AllMineralsAndMeteoritesPage({Key? key}) : super(key: key);

  @override
  _AllMineralsAndMeteoritesPageState createState() => _AllMineralsAndMeteoritesPageState();
}

class _AllMineralsAndMeteoritesPageState extends State<AllMineralsAndMeteoritesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i minerali e meteoriti'),
        actions: [
          IconButton(
