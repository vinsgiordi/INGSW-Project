...
class AllArchaeologyPage extends StatefulWidget {
  const AllArchaeologyPage({Key? key}) : super(key: key);

  @override
  _AllArchaeologyPageState createState() => _AllArchaeologyPageState();
}

class _AllArchaeologyPageState extends State<AllArchaeologyPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutta l\'archeologia'),
        actions: [
          IconButton(
