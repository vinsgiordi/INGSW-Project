...
import 'all_archaeology.dart';
import 'all_fossils.dart';
import 'all_minerals_and_meteorites.dart';

class ArchaeologyPage extends StatelessWidget {
  const ArchaeologyPage({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const AllArchaeologyPage()),
                      );
                    },
                    child: const Text(
                      'Visualizza tutto',
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const AllFossilsPage()),
                      );
                    },
                    child: const Text(
                      'Visualizza tutto',
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const AllMineralsAndMeteoritesPage()),
                      );
                    },
                    child: const Text(
                      'Visualizza tutto',
