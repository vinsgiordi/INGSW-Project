...
class AllFossilsPage extends StatefulWidget {
  const AllFossilsPage({Key? key}) : super(key: key);

  @override
  _AllFossilsPageState createState() => _AllFossilsPageState();
}

class _AllFossilsPageState extends State<AllFossilsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutti i fossili'),
        actions: [
          IconButton(
