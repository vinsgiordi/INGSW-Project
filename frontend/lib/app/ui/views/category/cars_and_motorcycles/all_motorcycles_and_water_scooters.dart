...
class AllMotorcyclesAndWaterScootersPage extends StatefulWidget {
  const AllMotorcyclesAndWaterScootersPage({Key? key}) : super(key: key);

  @override
  _AllMotorcyclesAndWaterScootersPageState createState() => _AllMotorcyclesAndWaterScootersPageState();
}

class _AllMotorcyclesAndWaterScootersPageState extends State<AllMotorcyclesAndWaterScootersPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le moto e scooter d\'acqua'),
        actions: [
          IconButton(
