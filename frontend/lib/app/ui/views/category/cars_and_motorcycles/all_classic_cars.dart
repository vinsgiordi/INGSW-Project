...
class AllClassicCarsPage extends StatefulWidget {
  const AllClassicCarsPage({Key? key}) : super(key: key);

  @override
  _AllClassicCarsPageState createState() => _AllClassicCarsPageState();
}

class _AllClassicCarsPageState extends State<AllClassicCarsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tutte le auto d\'epoca'),
        actions: [
          IconButton(
